    ...
    <div className="max-w-3xl space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#C9A84C] text-[#0A1628] font-montserrat font-bold text-xs uppercase tracking-wider px-4 py-2.5 rounded-xl transition hover:bg-yellow-400"
        >
      ...
      {loading ? (
        ...
        <div className="bg-[#0D1C35] border border-white/10 rounded-2xl p-12 text-center">
          ...
          <button
            onClick={() => navigate('/student/exeat/apply')}
            className="mt-4 font-montserrat text-xs bg-[#C9A84C] text-[#0A1628] font-bold px-5 py-2.5 rounded-xl"
          >
            Apply Now
          </button>
        </div>
        ...
        <div className="space-y-3">
          {applications.map(app => (
            <div key={app.id} className="bg-[#0D1C35] border border-white/10 rounded-2xl p-5 hover:border-white/20 transition">
