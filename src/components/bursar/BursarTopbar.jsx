...
export default function BursarTopbar({ onMenuClick }) {
    ...
    <div className="h-16 bg-[#0D1C35] border-b border-white/10 flex items-center justify-between px-6 shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-500 font-montserrat">{termLabel()}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-semibold text-white font-montserrat leading-tight">
